...
public class SensitiveInfoAdvice {
  ...
  public static void onExit(
    ...
    MethodLogUtil.onExit(LogLevel.INFO, typeName, methodName, MethodLogUtil.getSensitives(executable), arguments, result, startTime, sensitive.value());
  }
}
