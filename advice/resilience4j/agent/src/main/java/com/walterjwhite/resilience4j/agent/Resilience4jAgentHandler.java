...
public class Resilience4jAgentHandler implements AgentHandler {
            ...
            .with(
                new AgentBuilder.Listener() {
                  ...
                  public void onIgnored(
                      ...
                      boolean b) {
                    LOGGER.info(
                        "onIgnored: {} {} {} {}", typeDescription, classLoader, javaModule, b);
                  }
                  ...
                  public void onError(
                      ...
                      Throwable throwable) {
                    LOGGER.info(
                        "onError: {} {} {} {} {}", s, classLoader, javaModule, b, throwable);
                  }
    ...
    for (final InterceptorType interceptorType : InterceptorType.values()) {
      for (final Method method :
          agentApplicationInstance
              .getReflections()
              .getMethodsAnnotatedWith(interceptorType.getAnnotationClass())) {
  ...
  public static void setupResilience4j(
      final AgentApplicationInstance agentApplicationInstance,
      final AgentBuilder agentBuilder,
    ...
    ElementMatcher.Junction<MethodDescription> executeMethodDecription =
    ...
    agentBuilder
        ...
        .installOn(agentApplicationInstance.getInstrumentation());
  }
}
