...
public enum InterceptorType {
  ...
  TimeLimitedType(
    ...
    private static final ScheduledExecutorService sceduler = SchedulerFactory.getInstance().getScheduler();
    @Override
    public Function decorate(Object object, Function function) {
      final io.github.resilience4j.timelimiter.TimeLimiter timeLimiter = (io.github.resilience4j.timelimiter.TimeLimiter)object;
      return null;
    }
  };
