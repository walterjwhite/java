...
public class DelayPlugin extends Plugin.ForElementMatcher implements Plugin.Factory {
  ...
  public DynamicType.Builder<?> apply(
    ...
    for (MethodDescription.InDefinedShape methodDescription :
        typeDescription
            .getDeclaredMethods()
            .filter(includeDelayEligibleMethods())) {

      LOGGER.warn("implementing delay on {}", methodDescription.getName());
      builder =
  ...
  private static Junction<MethodDescription> includeDelayEligibleMethods() {
