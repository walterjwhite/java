...
public class DebugAdvice {
  ...
  public static long onEnter(
    ...
    return MethodLogUtil.onEnter(LogLevel.DEBUG, typeName, methodName, arguments);
  }
  ...
  public static void onExit(
    ...
    MethodLogUtil.onExit(LogLevel.DEBUG, typeName, methodName, arguments, result, startTime);
  }
}
