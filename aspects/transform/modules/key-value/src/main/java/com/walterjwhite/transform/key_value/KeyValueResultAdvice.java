...
// it would be more efficient if we do before advice
// if we find the key, then there is no need to actually invoke the method
// https://stackoverflow.com/questions/50237592/is-it-possible-to-return-from-a-method-using-advice-onmethodenter
@Transformer(
...
public class KeyValueResultAdvice {
  ...
  public static Class<? extends Entity> getResultClass(final String resultClassName)
      throws ClassNotFoundException {
    return (Class<? extends Entity>) Class.forName(resultClassName);
  }
