 ...
 *
 * <p>Implementations of this interface allow interested parties to <em>listen</em> to file system
...
public interface DirectoryWatcherService extends Service {
  ...
  /**
   * Notifies the implementation of <em>this</em> interface that <code>dirPath</code> should be
   * monitored for file system events. If the changed file matches any of the <code>globPatterns
   * </code>, <code>listener</code> should be notified.
   *
   * @param listener The listener.
   * @param dirPath The directory path.
   * @param globPatterns Zero or more file patterns to be matched against file names. If none
   *     provided, matches <em>any</em> file.
