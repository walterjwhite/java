...
public class BrowserUserConfigurationProvider implements Provider<BrowserUserConfiguration> {
  ...
  public BrowserUserConfigurationProvider(
    ...
    //    this.browserUserConfiguration =
    //        new BrowserUserConfiguration(
    //                null,
    //            Map.of(WebElementBrowserAction.Mouse, new
    // BrowserRandomDelayable(browserMouseMinimumDelay,
    //                    browserMouseMaximumDelay))
    //            ,
    //            browserTypeMinimumDelay,
    //            browserTypeMaximumDelay);
  }
