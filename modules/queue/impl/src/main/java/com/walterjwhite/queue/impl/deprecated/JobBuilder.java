...
public class JobBuilder {
   ...
   public QueuedJob build(AbstractEntity abstractEntity){
       ...
       // what if we fail to create the jobs even though the entity was successfully created/updated?
...
object) {
       ...
       EntityObject entityObject =
               new EntityObject(
                       // this expects the class to extends abstract entity, need to make it generic instead
                       repositoryProvider.get().query(new
