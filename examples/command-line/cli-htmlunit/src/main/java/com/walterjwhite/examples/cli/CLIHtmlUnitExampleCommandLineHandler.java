...
public class CLIHtmlUnitExampleCommandLineHandler implements CommandLineHandler {
    ...
    @Inject
    public CLIHtmlUnitExampleCommandLineHandler(@Property(CitrixUsername.class) final String username,@Property(CitrixPassword.class) final String password, @Property(CitrixPin.class) final String pin, @Property(CitrixUrl.class) final String url) {
