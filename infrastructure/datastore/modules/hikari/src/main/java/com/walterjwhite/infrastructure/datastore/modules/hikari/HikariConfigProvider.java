...
public class HikariConfigProvider implements Provider<HikariConfig> {
    ...
    public HikariConfigProvider(@Property(HikariJDBCDriverClassName.class) final String hikariDriverClassName, @Property(HikariJDBCDataSourceClassName.class) final String hikariDataSourceClassName, @Property(HikariJDBCUrl.class) final String hikariJDBCUrl, @Property(HikariJDBCUsername.class) final String hikariJDBCUsername, @Property(HikariJDBCPassword.class) final String hikariJDBCPassword) {
